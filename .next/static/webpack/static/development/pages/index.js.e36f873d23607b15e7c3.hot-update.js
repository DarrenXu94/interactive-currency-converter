      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios.get('/convert/AUD/USD');
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 4;
              return _this.apiDataCall();

            case 4:
              data = _context2.sent;
              console.log(data.data); // let res = await Currency(convertFrom, convertTo)
...
//# sourceMappingURL=index.js.e36f873d23607b15e7c3.hot-update.js.map