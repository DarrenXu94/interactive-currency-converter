...
function (_Component) {
  ...
  function StepConvertor() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "calculateValue", function () {
      ...
      var rates = JSONResponse.rates; // console.log(rates, this.props.convertTo)

      console.log(rates[_this.props.convertTo]);

      if (Object.values(rates).indexOf("EUR") > -1) {
        console.log("Reached");
        console.log(rates[_this.props.convertTo]);
      }
    });
...
//# sourceMappingURL=index.js.feb378f0b3aba24e9327.hot-update.js.map